...
export default async function SellerDashboardPage() {
  ...
  const { data: seller } = await supabase.from('seller_profiles').select('*').eq('user_id', user.id).maybeSingle();
