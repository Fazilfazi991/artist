...
export function Logo() {
  return <Link href="/" className="flex min-w-max items-center gap-3 text-rust">
    ...
    <span className="leading-none"><span className="block font-serif text-2xl font-semibold">Heritage Guild</span><span className="mt-1 hidden text-[10px] font-extrabold uppercase tracking-[.16em] text-muted sm:block">Modern Indian craft</span></span>
  </Link>;
}
