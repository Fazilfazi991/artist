...
export const STOREFRONT_TEMPLATES: Array<{ key: StorefrontTemplateKey; name: string; description: string; suitableFor: string[] }> = [
  ...
  { key: 'clean-grid', name: 'Clean Product Grid', description: 'Minimal, product-first storefront for jewellery, candles, accessories, and ready-to-ship catalogues.', suitableFor: ['Jewellery','Candles','Accessories','Ready-to-ship'] },
